...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    **Shiva Neelakantan**
    *Computer Science*
    Hello! My name is Shiva Neelakantan. I am a junior in Computer Science pursuing a minor in data science. My         interests within the bounds of my career include full-stack development, human-computer interaction, and machine     learning. Outside of my career, I enjoy activities that keep my body and mind sharp, such as reading up on dense     concepts, playing chess, and exercising. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Data science is a very dense field. Big data is becoming easier to collect and manipulate, and there is a high
    demand for the skills required to do so efficiently. For instance, Google has plenty of machine learning engineers working on refining their algorithms for advertisement targeting, web browsing, and more. All of this boils down to pulling data and making observations about it.
    
  ![Google's main office. Source: Google](/Users/shivn/Downloads/ds202/ds202_hw1/google-company.jpeg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such data set if you have.

    Answer: I am interested in the automotive industry and potential applications of alternative fuel sources. 
